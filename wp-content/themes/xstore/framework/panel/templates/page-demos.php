...
<div class="etheme-import-section <?php echo esc_attr( $class ); ?>">
    <div class="import-demos-wrapper admin-demos">
        <h1 class="etheme-page-title etheme-page-title-type-2"><?php esc_html_e('Import Demos', 'xstore'); ?>
            <span class="etheme-page-title-label green"><span class="et-counter">130+</span><span><?php esc_html_e('Demos', 'xstore');?></span></span>
        </h1>
        ...
        <div class="import-demos-header">
            <ul class="et-filters import-demos-filter et-filters-type-1">
                <li>
                    <span class="et-filter-toggle">
                        ...
                        <span><?php esc_html_e('Filter', 'xstore'); ?></span>
                    </span>
                    <ul>
            ...
            <div class="etheme-search">
                <input type="text" class="etheme-versions-search form-control" placeholder="<?php esc_attr_e('Search for versions', 'xstore'); ?>">
