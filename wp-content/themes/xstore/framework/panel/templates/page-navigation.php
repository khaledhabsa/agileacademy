...
//            style="display: inline-block;vertical-align: top;box-sizing: border-box;margin: 1px 0 -1px 2px;padding: 0 5px;min-width: 18px;height: 18px;border-radius: 9px;background-color: #d63638;color: #fff;font-size: 11px;line-height: 1.6;text-align: center;z-index: 26;">'.
//                $available_patches.
//                '</span>';
//        }
//    }
    $plugins .= sprintf(
        ...
        esc_html__( 'Patcher', 'xstore' ) . $available_patches_affix . ($available_patches_affix ? '' : $new_label)
    );
}
