...
class Etheme_WooCoommerce_Account {
    ...
    public function register_benefits_settings($custom_settings = array()) {
        ...
        if (count($settings) && isset($settings[self::$option_name])) {
            $local_settings = wp_parse_args( $settings[ self::$option_name ], $this->settings['loyalty_program'] );
        }
    ...
    public function register_tabs_settings($custom_settings = array()) {
        ...
        if (count($settings) && isset($settings[self::$option_name])) {
            $local_settings = wp_parse_args( $settings[ self::$option_name ], $this->settings['tabs'] );
        }
